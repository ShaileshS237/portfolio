...
export const PROJECTS = [
	{
		...
		type: "Mobile App",
		description:
			" (Mobile App) LoveAkot is a Social Media Android App for Akot(Native City) that aims to help people within a city. It helps in various ways like notifying what is going on in the city, help in to get contact no. of various people like electricians, plumbers, etc. in one click.",
		status: "2",
